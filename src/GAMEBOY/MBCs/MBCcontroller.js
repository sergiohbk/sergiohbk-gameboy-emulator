...
export class MBCcontroller{
    ...
    selectMBC(){
        if(this.cartridge.MBC1)
            this.MBC = new MBC1(this.cartridge, this.bus);
        else if(this.cartridge.MBC2)
            console.log("MBC2 not implemented");
        else if(this.cartridge.MBC3)
            this.MBC = new MBC3(this.cartridge, this.bus);
        else if(this.cartridge.MBC5)
            this.MBC = new MBC5(this.cartridge, this.bus);
        else
            this.MBC = new MBC(this.cartridge, this.bus);
    }
    //lectura
    readROM0(address){
